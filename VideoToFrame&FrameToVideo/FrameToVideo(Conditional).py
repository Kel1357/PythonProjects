...
if __name__ == '__main__':
    ...
    fps=int(input("FPS (e.g. 24):").strip())
    start=int(input("Start frame index (e.g. 0):").strip())
    end=int(input("End frame index, exclusive (e.g. 332):").strip())
    step=int(input("Step / interval between frames (e.g. 5 for 0,5,10,...):").strip())
